...
impl LoggableError {
    ...
    pub fn log_with_imp(&self, imp: &impl glib::subclass::types::ObjectSubclass) {
        ...
        self.log_with_object_internal_and_level(unsafe { imp.obj().unsafe_cast_ref::<glib::Object>()}, crate::DebugLevel::Error );
    }

    pub fn log_with_imp_and_level(&self, imp: &impl glib::subclass::types::ObjectSubclass, level: crate::DebugLevel) {
        use glib::subclass::prelude::*;

        self.log_with_object_internal_and_level(unsafe { imp.obj().unsafe_cast_ref::<glib::Object>() }, level);
    }
